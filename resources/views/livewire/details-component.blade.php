                    ...
                    <div class="detail-info">
                        ...
                        <div class="quantity">
                            ...
                            <div class="quantity-input">
                                ...
                                <a wire:click.prevent="decreaseQuantity" class="btn btn-reduce" href="#"></a>
                                <a wire:click.prevent="increaseQuantity" class="btn btn-increase" href="#"></a>
                            </div>
                        </div>
                        <div class="wrap-butons">
                        @if ($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                            <a href="#" wire:click="store({{ $product->id }}, '{{ $product->name }}', {{ $product->sale_price }})" class="btn add-to-cart">Add to Cart</a>
                        @else
