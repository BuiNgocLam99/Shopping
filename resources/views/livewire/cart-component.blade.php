        ...
        <div class=" main-content-area">
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    {{-- @php
                        dd(gettype($subtotalAfterDiscount));
                    @endphp --}}
                ...
                <div class="checkout-info">
                    @if (!Session::has('coupon'))
                        <label class="checkbox-field">
                            <input class="frm-input " wire:model="haveCouponCode" name="have-code" id="have-code" value="1" type="checkbox"><span>I have coupon code</span>
                        </label>
                            @if ($haveCouponCode == 1)
            ...
            <div class="wrap-iten-in-cart">
                ...
                @if (Session::has('s_success_message'))
                    <div class="alert alert-success">
                        <strong>Success</strong> {{ Session('s_success_message') }}
                    </div>
                @endif
