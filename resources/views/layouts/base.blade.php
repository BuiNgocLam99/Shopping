...
<head>
	...
	{{-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/6.2.10/css/tempus-dominus.min.css" integrity="sha512-pWpMljGtRWINCDZids0D5gLdAxmyqLmoNFTx2PQl0ZTIq9oFQRc/xPmLgPLxLFJmn1aPxXm8r+g8z8O2TNci+A==" crossorigin="anonymous" referrerpolicy="no-referrer" /> --}}
...
<body class="home-page home-01 ">
										...
										@if (Auth::user()->utype === 'ADM')
											...
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item" >
														<a title="Manage Home Slider" href="{{ route('admin.home-slider') }}">Manage Home Slider</a>
													</li>
													<li class="menu-item" >
	...
	{{-- <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/6.2.10/js/tempus-dominus.min.js" integrity="sha512-cifOHqqAnWtMTWkOTgbkgijgkfuV8zbYp6uIFR0zm+shcdL+kPJb0R3CqdhTm6mWqjP9t88iFEwbzYQ0+3ZKWg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script> --}}
	...
	<script src="https://cdn.tiny.cloud/1/uk0ai38lch4ly93mgszsfk01csvapdvs8k9opodzlxrbmnqp/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
